...
const CONTENT = {
  terms: {
    ...
    sections: [
      ...
      { h: '7. Contact', b: 'For account or legal questions related to these terms, contact info@rbtgenius.com.' },
    ],
  },
  privacy: {
    ...
    sections: [
      ...
      { h: '6. Contact', b: 'Privacy questions can be sent to info@rbtgenius.com.' },
    ],
  },
  refund: {
    title: 'Refund Policy',
    ...
    sections: [
      ...
      { h: '4. How to request help', b: 'For billing support or refund review, email info@rbtgenius.com and include the email used on your account, the plan involved, and the date of the charge.' },
    ],
  },
};
    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.contactBox}>
          ...
          <Text style={s.contactEmail}>info@rbtgenius.com</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
