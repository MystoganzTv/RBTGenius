...
const UI_TRANSLATIONS = {
  ...
  "Continue to Dashboard": "Ir al panel",
  "Go to Dashboard": "Ir al panel",
  "View Full Pricing": "Ver precios completos",
  "Visit Store": "Visitar tienda",
  "Practice With the Full Bank": "Practica con el banco completo",
  "Take Realistic Mock Exams": "Realiza exámenes simulados reales",
  "Track Meaningful Progress": "Rastrea tu progreso real",
  "See overall progress, streaks, readiness, and domain performance without noisy session swings.": "Ve el progreso general, rachas, preparación y rendimiento por dominio sin variaciones de sesión.",
  "Study Preview": "Vista previa de estudio",
  "Premium Preview": "Vista previa premium",
  "Smarter exam prep": "Preparación más inteligente",
  "Mock exam confidence": "Confianza en el simulacro",
  "Timed exams with clearer signals on whether you are ready to test.": "Exámenes cronometrados con señales claras sobre si estás listo para el examen.",
  "Native iOS & Android App": "App nativa iOS y Android",
  "Study anywhere — even offline.": "Estudia en cualquier lugar, incluso sin conexión.",
  "1,100+ practice questions available offline": "Más de 1,100 preguntas disponibles sin conexión",
  "85-question timed mock exams with pass/fail scoring": "Exámenes simulados de 85 preguntas con calificación aprobado/reprobado",
  "Tap-to-flip flashcards with topic filters": "Tarjetas con filtros por tema",
  "Haptic feedback and native iOS feel": "Retroalimentación háptica y experiencia nativa iOS",
  "Download on the": "Descarga en",
  "Get it on": "Disponible en",
  "What you get today": "Lo que obtienes hoy",
  "The current offer, without padding.": "La oferta actual, sin relleno.",
  "Available now": "Disponible ahora",
  "Coming soon": "Próximamente",
  "Mock Exams and Analytics": "Exámenes y Analíticas",
  "40-Hour Course": "Curso de 40 Horas",
  "Study the same shared bank in memory mode with quick answer explanations.": "Estudia el mismo banco compartido en modo memoria con explicaciones rápidas.",
  "Take timed 85-question mock exams and unlock readiness, coverage, and domain trends.": "Realiza exámenes de 85 preguntas y desbloquea preparación, cobertura y tendencias por dominio.",
  "Planned for a future release. It is not included in the current membership yet.": "Planificado para una versión futura. No está incluido en la membresía actual.",
  "Guest, Free, and Premium": "Invitado, Gratis y Premium",
  "See what changes when you upgrade.": "Ve qué cambia al actualizar.",
  "Feature": "Característica",
  "Guest": "Invitado",
  "Free": "Gratis",
  "Explore the product, preview pricing, and see how the study flow works before signing up.": "Explora el producto, previsualiza los precios y ve cómo funciona el flujo de estudio antes de registrarte.",
  "Build a daily routine with guided practice and flashcards.": "Crea una rutina diaria con práctica guiada y tarjetas.",
  "Unlock full mock exams, analytics, unlimited study support, and the complete prep experience.": "Desbloquea exámenes completos, analíticas, soporte ilimitado y la experiencia completa de preparación.",
  "Question bank": "Banco de preguntas",
  "Question Bank": "Banco de preguntas",
  "active questions": "preguntas activas",
  "tracked concepts": "conceptos rastreados",
  "Mock readiness": "Preparación",
  "average scaled score": "puntuación escalada promedio",
  "Keep practicing": "Sigue practicando",
  "passed": "aprobados",
  "taken": "realizados",
  "review": "a revisar",
  "Average mock score": "Puntuación promedio en simulacros",
  "scaled average score": "puntuación escalada promedio",
  "6 mock exams taken": "6 simulacros realizados",
  "2 passed, 4 to review": "2 aprobados, 4 a revisar",
  "Passed": "Aprobados",
  "Need review": "A revisar",
  "Unlimited premium AI support": "Soporte IA premium ilimitado",
  "RBT concepts": "Conceptos RBT",
  "Quick explanations": "Explicaciones rápidas",
  "Study prompts": "Sugerencias de estudio",
  "Concepts": "Conceptos",
  "Explain": "Explicar",
  ...
  "Free plan": "Plan gratis",
  "You can practice daily, review flashcards, and upgrade whenever you want more access.": "Puedes practicar a diario, repasar tarjetas y mejorar tu plan cuando quieras más acceso.",
  ...
  "If you cancel from Manage Billing": "Si cancelas desde Gestionar facturación,",
  "your premium access stays active until the end of your current billing period.": "tu acceso premium sigue activo hasta el final de tu periodo de facturación actual.",
  "Access continues": "Acceso activo",
  "Included": "Incluido",
  ...
  "Payments": "Pagos",
  "Invite to 7-day trial": "Invitar a prueba de 7 días",
  ...
  "Store purchase": "Compra en la tienda",
  "Password updated": "Contraseña actualizada",
  "Your password has been saved.": "Tu contraseña se guardó correctamente.",
  "Unable to update password": "No se pudo actualizar la contraseña",
  "Passwords do not match": "Las contraseñas no coinciden",
  "New password and confirmation must match.": "La nueva contraseña y la confirmación deben coincidir.",
  ...
  "Clear your answered questions, mock exam history, readiness, streak, and saved study sessions if you want a fresh start. Your account and payment history stay untouched.": "Borra tus preguntas respondidas, historial de simulados, preparación, racha y sesiones de estudio guardadas si quieres empezar de cero. Tu cuenta y tu historial de pagos quedan intactos.",
  "Your access and daily limits update automatically based on this plan.": "Tu acceso y tus límites diarios se actualizan automáticamente según este plan.",
  "Billing portal will appear after this membership is linked to a Stripe customer record.": "El portal de facturación aparecerá cuando esta membresía esté vinculada a un registro de cliente de Stripe.",
  "This will remove your question attempts, mock exams, readiness, streak, and saved study sessions. Your account and billing history will remain.": "Esto eliminará tus intentos de preguntas, simulados, preparación, racha y sesiones de estudio guardadas. Tu cuenta y tu historial de facturación se conservarán.",
  "Your account, billing history, and sign-in settings will stay intact.": "Tu cuenta, historial de facturación y configuración de inicio de sesión quedarán intactos.",
  "Readiness tracking that stays more stable over time": "Seguimiento de preparación más estable a lo largo del tiempo",
  "Topic distribution from your real attempt history": "Distribución de temas según tu historial real de intentos",
  "Mock exam trends and deeper performance breakdowns": "Tendencias de simulados y desgloses de rendimiento más detallados",
  "Keep answering questions to unlock this view.": "Sigue respondiendo preguntas para desbloquear esta vista.",
  "RBT Exam Outline — Section Mastery": "Esquema del examen RBT — Dominio por sección",
  "Aligned to the current exam outline": "Alineado al esquema actual del examen",
  "Complete your first mock exam to start building this chart.": "Completa tu primer simulado para empezar a construir esta gráfica.",
  "Email sent": "Correo enviado",
  "Your message was delivered successfully.": "Tu mensaje se entregó correctamente.",
  "Failed to send email": "No se pudo enviar el correo",
  "New This Week": "Nuevos esta semana",
  "Active (30d)": "Activos (30 días)",
  "Inactive": "Inactivos",
  "Conversion": "Conversión",
  "Active Trials": "Trials activos",
  "Trial → Monthly": "Trial → Mensual",
  "Today": "Hoy",
  "7 days": "7 días",
  "Total": "Total",
  "Subscription lifecycle": "Ciclo de suscripción",
  "Active trial": "Trial activo",
  "Converted to monthly": "Convertido a mensual",
  "Trial expired": "Trial vencido",
  "Trial ended": "Trial finalizado",
  "Trial ended · awaiting renewal": "Trial finalizado · esperando renovación",
  "Trial started": "Inicio del trial",
  "Trial ends": "Fin del trial",
  "Converted": "Convertido",
  "Latest renewal": "Última renovación",
  "No trial has been recorded for this member.": "No se ha registrado un trial para este miembro.",
  "Daily activity": "Actividad diaria",
  "Last 14 days · Eastern Time": "Últimos 14 días · hora del Este",
  "Questions (30d)": "Preguntas (30 días)",
  "Active days": "Días activos",
  "Questions answered per day": "Preguntas respondidas por día",
  "Blue = questions · Green dot = visit without questions": "Azul = preguntas · Punto verde = visita sin preguntas",
  "Visit tracking began Aug 12, 2026; study history is backfilled.": "El registro de visitas comenzó el 12 ago 2026; el historial de estudio sí incluye datos anteriores.",
  "Premium of Total": "Premium del total",
  "Export CSV": "Exportar CSV",
  "Last active: today": "Última actividad: hoy",
  "Never logged in": "Nunca inició sesión",
  "This action permanently removes the member profile, practice attempts, flashcard activity, mock exams, payments, sessions, and tutor conversations.": "Esta acción elimina permanentemente el perfil del miembro, los intentos de práctica, la actividad de tarjetas, los simulados, los pagos, las sesiones y las conversaciones con el tutor.",
  "Detailed billing records for": "Registros de facturación detallados de",
  "Send Email": "Enviar correo",
  "Compose a message for": "Redacta un mensaje para",
  "Subject": "Asunto",
  "e.g. Important update from RBT Genius": "p. ej. Actualización importante de RBT Genius",
  "Message": "Mensaje",
  "Write your message here...": "Escribe tu mensaje aquí...",
  "Sending...": "Enviando...",
  "Need help?": "¿Necesitas ayuda?",
  "Best way to contact us": "La mejor forma de contactarnos",
  "Common topics": "Temas frecuentes",
  "Accuracy": "Precisión",
  "Current session score": "Puntaje de la sesión actual",
  "Questions completed in this session": "Preguntas completadas en esta sesión",
  "Questions to revisit": "Preguntas por repasar",
  "Marked for review": "Marcadas para repasar",
  "Use your email and password to continue.": "Usa tu correo y contraseña para continuar.",
  "Or use email": "O usa tu correo",
  "Filters": "Filtros",
  "Overview": "Resumen",
  "cards": "tarjetas",
  "complete": "completado",
  "Hide": "Ocultar",
  "Flashcard Review": "Repaso de tarjetas",
  "Focus the deck without pushing the flashcard down the page.": "Concéntrate en el mazo sin que la tarjeta se desplace hacia abajo en la página.",
